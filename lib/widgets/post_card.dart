    ...
    return user == null
        ...
        : Container(
            ...
            decoration: BoxDecoration(
              border: Border.all(
                color: widthDevice > webScreenSize ? secondaryColor : mobileBackgroundColor,
              ),
            ),
            margin: widthDevice > webScreenSize
                ? EdgeInsets.symmetric(horizontal: widthDevice * 0.3, vertical: 10)
                      ...
                      child: IconButton(
                        onPressed: () async {
                          await FirestoreMethods().likePost(
                              user.uid, widget.snap['idPost'].toString(), widget.snap['likes']);
                          setState(() {});
                        },
